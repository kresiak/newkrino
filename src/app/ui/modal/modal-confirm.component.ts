...
@Component({
  ...
  template: `
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-warning" (click)="closeModal()">{{'GENERAL.YES' | translate}}</button>
      <button type="button" class="btn btn-info" (click)="activeModal.dismiss('Cancel click')">{{'GENERAL.CANCEL' | translate}}</button>
    </div>
  `
})
